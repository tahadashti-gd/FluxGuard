...
#region پارامتر های ارتباطات

using var cts = new CancellationTokenSource();
var bot = new TelegramBotClient("7675770029:AAFDkAiTQbHbCXx6rbk5xJ1aVfNukbpSa4A", cancellationToken: cts.Token);
...
// پاسخدهی و مدیریت دستور های متفاوت از پیام
async Task OnUpdate(Update update)
{
    ...
    if (update is { CallbackQuery: { } query }) // non-null CallbackQuery
    {
        ...
        //await bot.EditMessageTextAsync(5062451231, id, "test");
    }
}

int CommandID(string msg)
{
    if (msg == "/start")
    {
        return 0;
